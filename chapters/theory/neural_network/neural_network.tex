...
\caption[Fully connected neural network illustration]{An illustration of the graph constructed by two artificial neurons with three input nodes. Colored lines show the flow of information from input to the predicted value. For details on notation see the text.}\label{fig:ann_illustration}
\end{figure}
