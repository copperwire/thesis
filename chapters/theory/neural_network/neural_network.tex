...
\todo{update notation with layer indexation, and algorithm for backprop?}
...
\todo{Make activation function plots and write out section on act. functions}

\subsection{Deep learning regularization}

As neural networks can be made arbitrarily complex reducing the degree of over-fitting is an important concern. 
