...
\begin{frame}[t]{K-means results}
	\begin{figure}[h]
		\centering 
		\subfloat{\includegraphics[width=0.3\textwidth]{../chapters/results/clustering/plots/Simulatedvgg_pca_conf_mat.pdf}}
		\subfloat{\includegraphics[width=0.3\textwidth]{../chapters/results/clustering/plots/Filteredvgg_pca_conf_mat.pdf}}
		\subfloat{\includegraphics[width=0.3\textwidth]{../chapters/results/clustering/plots/Fullvgg_pca_conf_mat.pdf}}
...
\begin{frame}[t]{Deep Clustering Results}
	\centering 
	\begin{figure}[h]
		\subfloat{\includegraphics[height=3cm]{../chapters/results/clustering/plots/Filtered_mixae_conf_mat.pdf}}
		\subfloat{\includegraphics[height=3cm]{../chapters/results/clustering/plots/full_mixae_conf_mat.pdf}}
